...
{$endif OLD_DWSCRIPT}
  ...
  ScriptModule,
  ScriptProviderAPI,
  ScriptDebuggerDialogGotoLine,
  ScriptDebuggerDialogEvaluate,
  ScriptDebuggerFrameLocalVariables,
  ScriptDebuggerFrameWatches,
  ScriptDebuggerFrameCallStack,
  ScriptDebuggerFrameSymbols,
  ScriptDebuggerFrameStack,
  ScriptDebuggerFrameAST,
  ScriptDebuggerFrameBreakPoints;
